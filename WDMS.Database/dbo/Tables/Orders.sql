CREATE TABLE [dbo].[Orders] (
    ...
    CONSTRAINT [FK_Orders_Admin] FOREIGN KEY ([Operator]) REFERENCES [dbo].[Admin] ([AdminId]),
    CONSTRAINT [FK_Orders_Admin1] FOREIGN KEY ([Assistant]) REFERENCES [dbo].[Admin] ([AdminId]),
